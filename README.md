...
- derivations : this folder don't contain any code. It only contains docs where we put our ideass and different reasoning from the start to the very end. It may be useful for anybody who wants to provide further work related to the project. 
